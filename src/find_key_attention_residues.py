...
def print_top_residues(scores, excluded_inds, res_ids, top_n):
    ...
    print(f"\nTop {top_n} residues influencing the given pocket:{top_resnums}")
...
if __name__ == '__main__':
    ...
    excluded_sel = '+'.join(str(r) for r in sorted(res_ids[excluded_inds].tolist()))
    ...
    print(f'    spectrum b, blue_white_red, prot and not excluded, minimum=0, maximum=1')
